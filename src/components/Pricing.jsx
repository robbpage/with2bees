    ...
    return (
        <motion.div id="pricing" className="font-khand text-white text-[1.75rem]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <div className="max-w-screen-lg m-auto">
                <h3 className="mt-24 font-khand font-bold text-6xl text-left">NEED A <span className="text-amber-900">WEB HOST </span> FOR YOUR SITE?</h3>
                <p className="my-4">
                ...
                <p className="text-yellow-200 font-bold"><Icon id="hosting" classes="fill-yellow-200 w-7 inline mb-1" /> Hosting plans start as low as $1.99/month!</p>
                <h3 className="mt-24 font-khand font-bold text-6xl text-left"> NO WORRIES, <span className="text-amber-900">WE&apos;RE HERE </span> TO HELP</h3>
                ...
                <p className="text-yellow-200 font-bold">Head over to our <Link to="/contact" className="font-bold text-white hover:underline hover:text-white">contact</Link> page and join the hive. Unleash your digital potential today! 🐝</p>
            </div>
        </motion.div>
    )
}
