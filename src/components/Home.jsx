...
function Home() {
    return (
        <motion.div id="home" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            ...
            <h3 className="max-w-screen-lg m-auto mt-24 px-4 font-khand font-bold text-6xl text-left">
                EASY, <span className="text-amber-900">HASSLE FREE </span> PRICING.
            </h3>
            <div className="max-w-screen-lg m-auto mt-8 px-4 font-khand text-[1.75rem] text-white">
                ...
                <p className="block font-khand text-3xl text-yellow-200 font-bold text-center md:text-left mt-10">
                    For more information and options please visit our <Link to="/pricing" className="font-bold text-white hover:underline hover:text-white">Pricing</Link> page.<br /><br />
                    Visit <Link to="/projects" className="font-bold text-white hover:underline hover:text-white">The Hive</Link> to see some of the projects we&apos;ve helped bring to life!
                </p>
            </div>

            <div className="max-w-screen-lg m-auto mt-40">
                <h3 className="font-khand text-6xl text-left font-bold px-4 pb-10">
                    ANY <span className="text-amber-900">QUESTIONS?</span> <br className="md:hidden" />LET&apos;S TALK!
                </h3>
